						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header"
									...
									<h5 class="text-white m-0">${type}Exam</h5>
								</div>
								<div class="card-body">
									<%@taglib prefix="f"
									...
									<f:form class="cmxform" id="ExamForm" method="post"
										action="saveExam" modelAttribute="ExamVO"
										...
										<fieldset>
											...
											<div class="row">
												...
												<div class="form-group col-12">
													<label>Upload Exam Timetable<span
												...
												<c:if test="${f1:length(ExamVO.fileName) ne ''}">

													<div class="form-group col-12">
														<a
															href="<%=request.getContextPath()%>/documents/exam/${ExamVO.fileName}"
															target="_blank"> <img
															src="<%=request.getContextPath()%>/adminResources/images/pdf.jfif"
															alt="${ExamVO.fileName}" height="50px" width="50px">
														</a>
													</div>
													<div class="form-group col-12">${ExamVO.fileName}</div>
												</c:if>
