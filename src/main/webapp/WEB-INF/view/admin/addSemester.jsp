...
<title>Admin | ${type}Semester</title>
<!-- plugins:css -->
<link rel="stylesheet"
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header"
									...
									<h5 class="text-white m-0">${type}Semester</h5>
								</div>
								<div class="card-body">
									...
									<f:form class="cmxform" id="semesterForm" method="post"
										action="saveSemester" modelAttribute="SemesterVO"
										...
										<fieldset>
											...
											<div class="row">
												...
												<div class="form-group col-2">
													<a class="btn btn-primary mt-4" onclick="addSem()"> <i
