						...
						<div class="auth-form-transparent text-left p-3">
							<div class="brand-logo">
								<img
									...
									alt="logo"><font color="indigo"><b> --- Bright Future --- </b></font>
							</div>
								...
								onsubmit="return changePassword()" action="savechangepassword">
									...
									<div class="form-group">
										...
										<input type="password" placeholder="Enter Old Password"
											...
											<span
											style="color: red;" id="oldPasswordError">your old password is not match</span>
											</c:if>
									...
									<div class="form-group">
										<div class="input-group">
											...
											style="color: red;" id="confirmPasswordError"></span>
