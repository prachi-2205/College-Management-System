				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header"
							...
							<h5 class="text-white m-0">View Degree</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
										...
										<table id="order-listing" class="table">
											...
											<c:forEach items="${degreeList}" var="i" varStatus="j">
												<tr>
													...
													<td><a href="editDegree?id=${i.id}"> <i class="mdi mdi-pencil"
															style="font-size: 20px;"></i>
													</a> <a href="deleteDegree?id=${i.id}"> <i class="mdi mdi-delete"
