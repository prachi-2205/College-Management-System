...
<title>Admin | View Semester</title>
<!-- plugins:css -->
<link rel="stylesheet"
				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header"
							...
							<h5 class="text-white m-0">View Semester</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									...
									<%@taglib prefix="c"
										...
										<table id="order-listing" class="table">
											...
											<tbody>
											<c:forEach items="${semesterList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.degree.degreeName}</td>
													<td>${i.semesterNo}</td>
													<td>${i.semesterTime}</td>
													


													<td><a href="editSemester?id=${i.id}"> <i class="mdi mdi-pencil"
															style="font-size: 20px;"></i>
													</a> <a href="deleteSemester?id=${i.id}"> <i class="mdi mdi-delete"
