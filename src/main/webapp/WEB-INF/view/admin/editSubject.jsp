						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header"
									...
									<h5 class="text-white m-0">Edit Subject</h5>
								</div>
								<div class="card-body">
									...
									<f:form class="cmxform" id="subjectForm" method="post"
										action="updateSubject" modelAttribute="SubjectVO"
										...
										<fieldset>
											...
											<f:hidden path="id" />
											<f:hidden path="degree.id" />
											<f:hidden path="semester.id" />
										...
										<%-- <fieldset>
											...
											<div class="form-group">
												...
												<f:select path="degree.id" class="form-control" id="degree">
													<option value="default" selected>--- Choose Degree
														Name ---</option>
													<c:forEach items="${degreelist}" var="i">
														<c:if test="${subjectVO.degree.id ne  i.id}">
															<f:option value="${i.id}">${i.degreeName}</f:option>
											...
											<div class="form-group">
												...
												<f:select path="semester.id" class="form-control"
													...
													<c:forEach items="${semesterlist}" var="i">
														<c:if test="${subjectVO.semester.id ne  i.id}">
															<f:option value="${i.id}">${i.semesterNo}</f:option>
														</c:if>
													</c:forEach>
												</f:select>
