				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header"
							...
							<h5 class="text-white m-0">View Assignment</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${assignmentList}" var="i" varStatus="j">
													<tr>
														<td>${j.count }</td>
														...
														<td><a href="editAssignment?id=${i.id}"> <i
																class="mdi mdi-pencil"
																style="font-size: 20px;"></i>
														</a>
														
														<a href="deleteAssignment?id=${i.id}"> <i
