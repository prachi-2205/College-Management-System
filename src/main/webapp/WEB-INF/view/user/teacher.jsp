	...
	<div class="breadcrumb_bg">
		<div class="container">
			<ul class="breadcrumb breadcrumb-arrow">
				...
				<li class="active"><span>Teachers</span></li>
			</ul>
		</div>
	</div>
						...
						<div class="row">
								...
								<div class="teachers_pro custom_hover_img">
									...
									<%-- <c:if test="${i.gender eq 'Female' }">
										<img class="img-responsive"
											alt="${i.firstName}
											${i.lastName}"
											src="<%=request.getContextPath()%>/userResource/images/professor_female.png">
									</c:if> 
									...
									<c:if test="${i.gender eq 'Male' }">
										<img class="img-responsive"
											alt="${i.firstName}
											${i.lastName}"
											src="<%=request.getContextPath()%>/userResource/images/professor_male.png">
									</c:if>
									...
									<img class="img-responsive"
										alt="${i.firstName}
											${i.lastName}"
										src="<%=request.getContextPath()%>/documents/faculty/${i.fileName}">
							...
							<div class="col-xs-8 col-sm-8 col-8">
								<div class="teacher_text">
									<h5>
										<a href="teacher-profile?id=${i.id}">${i.firstName}
											${i.lastName}</a>
									</h5>
									<h6>${i.designation}</h6>
									<a href="teacher-profile?id=${i.id}"><button type="button"
											class="btn btn-default profile_btn">View Profile</button></a>
								</div>
							</div>
						</div>
					</div>
