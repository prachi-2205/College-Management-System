...
<body data-spy="scroll" data-target=".navbar" data-offset="50"
	...
	<div class="teacher_bg">
		<div class="header_title">
			<h1>${facultyVO.firstName}&nbsp&nbsp${facultyVO.lastName}</h1>
	...
	<div class="breadcrumb_bg">
		<div class="container">
			<ul class="breadcrumb breadcrumb-arrow">
				...
				<li class="active"><span>Teachers &nbsp> </span></li>
				<li class="active"><span>${facultyVO.firstName}&nbsp${facultyVO.lastName}</span></li>
			</ul>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="page_tital">
						<h2>${facultyVO.firstName}&nbsp${facultyVO.lastName}</h2>
						<hr class="tital_border m-l-0">
						<p>${facultyVO.designation}</p>
					</div>
					<div class="teacher_contect">
						<i class="fa fa-envelope-o"></i> <a href="javascript:void(0)">
							${facultyVO.loginVO.username}</a> <i class="fa fa-phone"></i> <a
							href="tel:+91(02)1234567989"> + 91 - ${facultyVO.phoneNumber}
						</a>
						<p class="m-t-30"><b>Degree</b> : ${facultyVO.degree }</p>
						<p class="m-t-30"><b>Address</b> : ${facultyVO.address }</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-3">
					<div class="profile_img">

						<%-- <c:if test="${facultyVO.gender eq 'Female' }">
							<img class="img-responsive"
								alt="${i.firstName}
											${i.lastName}"
								src="<%=request.getContextPath()%>/userResource/images/professor_female.png" width="5px" height="400">
						</c:if>
						<c:if test="${facultyVO.gender eq 'Male' }">
							<img class="img-responsive"
								alt="${i.firstName}
											${i.lastName}"
								src="<%=request.getContextPath()%>/userResource/images/professor_male.png" width="5px" height="400">
						</c:if> --%>
						
						<img src="<%=request.getContextPath()%>/documents/faculty/${facultyVO.fileName}" height="280px" width="300px">
