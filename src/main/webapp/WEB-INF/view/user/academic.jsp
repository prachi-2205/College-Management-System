...
<html lang="en-us">
<head>
<title>Academic Assignment</title>
<link rel="icon"
...
<body onload="getSemesterByDegree()">
	...
	<div class="breadcrumb_bg">
		<div class="container">
			<ul class="breadcrumb breadcrumb-arrow">
				...
				<li class="active"><span>Timetable - Academic </span></li>
			</ul>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<f:form action="userViewAcademic" method="get">
						<div class="row">
	...
	<script src="<%=request.getContextPath()%>/adminResources/js/validation/addAcademic.js"></script>
</body>
</html>